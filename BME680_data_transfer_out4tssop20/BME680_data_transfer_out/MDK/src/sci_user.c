...
* @param  None
***********************************************************************************************************************/
static void iic11_interrupt(void)
{
    if (((SCI0->SSR03 & _0002_SCI_PARITY_ERROR) == 0x0002U) && (g_iic11_tx_count != 0U))
    {
        iic11_callback_master_error(MD_NACK);
    }
    else if(((SCI0->SSR03 & _0001_SCI_OVERRUN_ERROR) == 0x0001U) && (g_iic11_tx_count != 0U))
    {
    ...
    else
    {
        ...
        if ((g_iic11_master_status_flag & _01_SCI_IIC_SEND_FLAG) == 1U)
        {
            ...
            {
                SCI0->SIO11 = *gp_iic11_tx_address;
                gp_iic11_tx_address++;
                g_iic11_tx_count--;
            }
            else
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    *gp_iic11_rx_address = SCI0->SIO11;
                    gp_iic11_rx_address++;
                    g_iic11_rx_count++;
