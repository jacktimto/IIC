                    ...
                    bme680_com_fptr_t bus_read, sleep_fct sleep, state_load_fct state_load, config_load_fct config_load)
{
    ...
    {
    	//PDEBUG("bsec_init failed, bme680_status=%d\r\n", ret.bsec_status);
        return ret;
    }
    ...
    {       
        ...
        if (ret.bsec_status != BSEC_OK)
        {
        	//PDEBUG("bsec_set_configuration failed, bme680_status=%d\r\n", ret.bsec_status);
            return ret;
        }
    }
    ...
    {       
        ...
        if (ret.bsec_status != BSEC_OK)
        {
        	//PDEBUG("bsec_set_state failed, bme680_status=%d\r\n", ret.bsec_status);
            return ret;
        }
    }
    ...
    if (ret.bsec_status != BSEC_OK)
    {
    	//PDEBUG("bme680_bsec_update_subscription failed, bme680_status=%d\r\n", ret.bsec_status);
        return ret;
    }
